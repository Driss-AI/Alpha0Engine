...
# ── Lane-specific red flags (Sprint 7.6 → logic moved to shared in 9.3) ─────
# Re-exported from shared.scoring.red_flags so both this worker and the screener
# share one implementation. Importing this way keeps existing risk-filter tests
# (which import from risk_engine) working unchanged.
from shared.scoring.red_flags import (  # noqa: E402,F401
    SHARED_RED_FLAGS,
    CRITICAL_RED_FLAGS,
    detect_red_flags,
)
